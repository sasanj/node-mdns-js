    ...
    if (interfaces.hasOwnProperty(key)) {
      for (var i = 0; i < interfaces[key].length; i++) {
        ...
        //this.createSocket(index++, key,
          //iface.address, 5353, this.bindToAddress.bind(this));
...
Networking.prototype.createSocket = function () {
  ...
  debug('creating socket for %s:%d', MDNS_MULTICAST,MDNS_MULTICAST_PORT);
  this.created++;
  ...
  sock.bind(MDNS_MULTICAST_PORT,'0.0.0.0',  function () {
    ...
    _me.bindToAddress(null,0, 'multicast', sock);
  });
